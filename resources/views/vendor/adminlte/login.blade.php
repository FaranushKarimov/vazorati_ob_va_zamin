...
@section('body')
    <div class="login-logo">
        ...
        <h4 style="font-weight: 800; text-shadow:0 0 8px #fff;">Институт водных проблем, гидроэнергетики и экологии Национальной академии наук Таджикистана</h4>
        <h3 style="font-weight: 800; text-shadow:0 0 8px #fff;">Структура базы данных Института водных проблем, гидроэнергетики и экологии</h3>
    </div>
    <div class="login-box">
        <!-- /.login-logo -->
        <div class="login-box-body">
            ...
            @endif
            @if (config('adminlte.register_url', 'register') && 0)
                <p>
